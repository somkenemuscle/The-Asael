    ...
    return (
        <section className="bg-neutral-950 pt-40 pb-2">
            <div className="py-20">
                ...
                <header className="text-white font-semibold text-6xl text-center">We Create <br />Unforgettable <span className="bg-gradient-to-r from-pink-500 to-yellow-300 text-transparent bg-clip-text"> <i>   Events </i></span>

 
                </header>
                <p className="text-center text-gray-300 text-sm font-mono mt-4">From weddings to corporate parties, we handle everything beautifully
                </p>
